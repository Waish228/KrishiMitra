  ...
  return (
    <div className="page-container max-w-6xl mx-auto">
      <PageHeader
        ...
        subtitle="Holistic 14-day schedule with AI-driven insights"
      ...
      <div className="grid lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 space-y-6">
          <Card className="p-5">
            <h2 className="font-semibold text-gray-900 dark:text-white text-sm mb-4">Farm Details</h2>
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">Growth Stage</label>
                <select
                  value={selectedStage}
              ...
              <div>
                <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">Land Area (Acres)</label>
                <input
                  type="number"
                  value={area}
              ...
              >
                {isGenerating ? 'Generating Plan...' : 'Generate 14-Day Plan'}
              </Button>
            </div>
          </Card>
        ...
        <div className="lg:col-span-8">
          {!plan && !isGenerating && (
            <div className="h-full min-h-[400px] flex flex-col items-center justify-center text-center p-8 bg-gray-50 dark:bg-slate-800/50 rounded-2xl border border-dashed border-gray-200 dark:border-slate-700">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                Generate Your Holistic Farming Plan
              </h3>
              <p className="text-gray-500 dark:text-gray-400 max-w-sm text-sm">
                Enter your crop details to receive a comprehensive AI-driven watering, fertilizing, and task schedule for the next two weeks.
              </p>
            </div>
          )}
          ...
          {isGenerating && (
            <div className="h-full min-h-[400px] flex flex-col items-center justify-center text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400 animate-pulse">Analyzing optimal schedules...</p>
            </div>
          )}
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <Card className="p-5 border-l-4 border-l-blue-500 relative overflow-hidden">
                  ...
                  <div className="space-y-3 relative z-10">
                    <div>
                      <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">Frequency</p>
                      <p className="text-sm font-semibold text-gray-900 dark:text-white">{plan.waterSchedule.frequency}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">Amount</p>
                ...
                <Card className="p-5 border-l-4 border-l-green-500 relative overflow-hidden">
                  ...
                  <div className="space-y-3 relative z-10">
                    <div>
                      <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">NPK Split</p>
                      <p className="text-sm font-semibold text-gray-900 dark:text-white">{plan.fertilizerSchedule.npkSplit}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">Sources</p>
              ...
              <Card className="p-5">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex gap-3 text-xs">
                    ...
                    <span className="flex items-center gap-1 text-gray-500 dark:text-gray-400">
                      <FlaskConical className="w-3 h-3 text-green-500" /> Fertilizer
                    </span>
                    <span className="flex items-center gap-1 text-gray-500 dark:text-gray-400">
                      <CheckSquare className="w-3 h-3 text-purple-500" /> Task
                    </span>
                  </div>
                </div>
                    ...
                    >
                      ...
                      <div className="mt-auto space-y-1.5 flex-1 flex flex-col justify-end">
                        {day.events.length > 0 ? (
                          ...
                          <div className="text-[10px] text-gray-300 dark:text-slate-600 italic">No events</div>
                        )}
                      </div>
                    </div>
                  ))}
